...
NAKED static void sub_80F0708(void)
{
    asm_unified("\tpush {r4-r7,lr}\n"
                    ...
                    "\t.align 2, 0\n"
                    "_080F0748:\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_OFF_AIR\n"
                    "\t.int _080F0848  @ TVSHOW_FAN_CLUB_LETTER\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_RECENT_HAPPENINGS\n"
                    "\t.int _080F0860  @ TVSHOW_PKMN_FAN_CLUB_OPINIONS\n"
                    "\t.int _080F0878  @ TVSHOW_UNKN_SHOWTYPE_04\n"
                    "\t.int _080F0890  @ TVSHOW_NAME_RATER_SHOW\n"
                    "\t.int _080F08BC  @ TVSHOW_BRAVO_TRAINER_POKEMON_PROFILE\n"
                    "\t.int _080F08D4  @ TVSHOW_BRAVO_TRAINER_BATTLE_TOWER_PROFILE\n"
                    "\t.int _080F07F0  @ TVSHOW_CONTEST_LIVE_UPDATES\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_3_CHEERS_FOR_POKEBLOCKS\n"
                    "\t.int _080F081C  @ TVSHOW_BATTLE_UPDATE\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_FAN_CLUB_SPECIAL\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_CONTEST_LIVE_UPDATES_2\n"
                    "\t.int _080F0AD8  @ \n"
                    "\t.int _080F0AD8  @ \n"
                    "\t.int _080F0AD8  @ \n"
                    "\t.int _080F0AD8  @ \n"
                    ...
                    "\t.int _080F0AD8  @ \n"
                    "\t.int _080F0AD8  @ \n"
                    "\t.int _080F0900  @ TVSHOW_POKEMON_TODAY_CAUGHT\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_SMART_SHOPPER\n"
                    "\t.int _080F0918  @ TVSHOW_POKEMON_TODAY_FAILED\n"
                    "\t.int _080F0944  @ TVSHOW_FISHING_ADVICE\n"
                    "\t.int _080F095C  @ TVSHOW_WORLD_OF_MASTERS\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_TODAYS_RIVAL_TRAINER\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_TREND_WATCHER\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_TREASURE_INVESTIGATORS\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_FIND_THAT_GAMER\n"
                    "\t.int _080F0974  @ TVSHOW_BREAKING_NEWS\n"
                    "\t.int _080F09A0  @ TVSHOW_SECRET_BASE_VISIT\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_LOTTO_WINNER\n"
                    "\t.int _080F09C0  @ TVSHOW_BATTLE_SEMINAR\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_TRAINER_FAN_CLUB\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_CUTIES\n"
                    "\t.int _080F09F4  @ TVSHOW_FRONTIER\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_NUMBER_ONE\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_SECRET_BASE_SECRETS\n"
                    "\t.int _080F0AE2_break  @ TVSHOW_SAFARI_FAN_CLUB\n"
                    "\t.int _080F0AD8  @ \n"
                    "\t.int _080F0AE2_break  @ TVSHOW_MASS_OUTBREAK\n"
                    "_080F07F0:\n"
                    "\tldr r0, [r3]\n"
                    "\tmov r1, r9\n"
                    "\tadds r4, r7, r1\n"
