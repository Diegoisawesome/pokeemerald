...
void DeactivateAllTextPrinters (void)
{
    ...
    for (i = 0; i < NUM_TEXT_PRINTERS; i++)
        gTextPrinters[i].sub_union.sub.active = FALSE;
}
...
bool16 AddTextPrinter(struct TextSubPrinter *textSubPrinter, u8 speed, void (*callback)(struct TextSubPrinter *, u16))
{
    ...
    gTempTextPrinter.sub_union.sub.active = TRUE;
    ...
    else
    {
        ...
        gTextPrinters[textSubPrinter->windowId].sub_union.sub.active = FALSE;
    }
...
void RunTextPrinters(void)
{
    ...
    if (gUnknown_03002F84 == 0)
    {
        for (i = 0; i < NUM_TEXT_PRINTERS; ++i)
        {
            if (gTextPrinters[i].sub_union.sub.active)
            {
...
u16 Font0Func(struct TextPrinter *textPrinter)
{
    ...
    if (subStruct->field_1_top == FALSE)
    {
        textPrinter->sub_union.sub.font_type = 0;
        subStruct->field_1_top = TRUE;
    }
...
void TextPrinterDrawDownArrow(struct TextPrinter *textPrinter)
{
    ...
    if (gTextFlags.flag_2 == FALSE)
    {
        if (subStruct->field_1)
        {
            subStruct->field_1 = ((*(u32*)subStruct) << 19 >> 27) - 1;    // convoluted way of getting field_1, necessary to match
        }
        else
        {
            FillWindowPixelRect(
...
u16 RenderText(struct TextPrinter *textPrinter)
{
    ...
    case 0: // _080057F0
        ...
        case 0xF8+4: //_080058E0
            ...
            case 11: // _08005A5C
                currChar = *textPrinter->subPrinter.current_text_offset;
                textPrinter->subPrinter.current_text_offset++;
                currChar |= *textPrinter->subPrinter.current_text_offset * 256;
                textPrinter->subPrinter.current_text_offset++;
                PlayBGM(currChar);
                return 2;
            case 16: // _08005A76
    ...
    case 2: // _08005C8C
        ...
        {
            FillWindowPixelBuffer(textPrinter->subPrinter.windowId, (textPrinter->subPrinter.bgColor * 16) | textPrinter->subPrinter.bgColor);
            textPrinter->subPrinter.currentX = textPrinter->subPrinter.x;
            textPrinter->subPrinter.currentY = textPrinter->subPrinter.y;
            textPrinter->state = 0;
        }
    ...
    case 4: // _08005CF0
        if (textPrinter->scrollDistance)
        {
            ...
            {
                ScrollWindow(textPrinter->subPrinter.windowId, 0, textPrinter->scrollDistance, (textPrinter->subPrinter.bgColor * 16) | textPrinter->subPrinter.bgColor);
                textPrinter->scrollDistance = 0;
            }
            else
            {
                ScrollWindow(textPrinter->subPrinter.windowId, 0, speed, (textPrinter->subPrinter.bgColor * 16) | textPrinter->subPrinter.bgColor);
